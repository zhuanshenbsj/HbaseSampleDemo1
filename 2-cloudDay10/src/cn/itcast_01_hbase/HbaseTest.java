...
public class HbaseTest {
	...
	public void init() throws Exception {
		...
		config.set("hbase.zookeeper.quorum", "name1,data1,data2,data3");// zookeeper地址
	...
	public void uodateData() throws Exception {
		...
		put.add(Bytes.toBytes("info1"), Bytes.toBytes("password"), Bytes.toBytes(1234));
		//插入数据
		table.put(put);
		//提交
		table.flushCommits();
	...
	public void queryData() throws Exception {
		//也可以查单个列族或者单个列,get.add 类似delete
		Get get = new Get(Bytes.toBytes("1111"));
		//get.addColumn(Bytes.toBytes("info1"), Bytes.toBytes("age"));
